...
- Qin J, Fei L, Zhu J, Wen J, **Tian C**, Wu S. Scalable discriminative disrcrete hashing for large-scale cross-modal retrival [C].  IEEE ICASSP 2021. (Accepted)  (EI-CCF B)
- Fei L, Teng S,  Wen J,  **Tian C**, Liu D, Zhang W. Jointly Learning Compact Multi-instance FKP Descriptor [C]. International Joint Conference on Biometrics (IJCB), 2020 (Accepted) (EI-CCF C)
- Fei L, Zhang B, Wen J, **Tian C**, Liu P, Zhao S. Joint Learning Multiple Curvature Descriptor for 3D Palmprint Recognition [C]//ICPR, 2020.  (Accepted) (EI-CCF C)
- Fei L, Zhang B, Teng S, Gan Z, **Tian C**, Zhang W. Learning Discriminative Finger-knuckle-print Descriptor[C]// ICASSP 2019 :2137-2141.  (EI-CCF B)
...
1. **Tian C,** Xu Y,  Wen J, Wu J, Liu C. Image denoising method, device, equipment and storagemedium basded on deep learning. Chinese invention patent. 2019.
2. **Tian C**, Xu Y. An image denoising method based on deep BN convolutional neural network. Chinese invention patent. 2018. 
3. **Tian C**, Xu Y. Image restoration method based on enhanced neural network. Chinese invention patent. 2018. 
